                        ...
                        <div className="mb-3">
                          <div className="flex items-center justify-between text-sm mb-1">
                            ...
                            <span className="text-gray-900 font-medium">
                              {upload.progress !== undefined ? upload.progress : Math.round((upload.processed_rows / upload.total_rows) * 100)}%
                            </span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                            <div
                              className="bg-gradient-to-r from-blue-500 to-blue-600 h-2.5 rounded-full transition-all duration-500"
                              style={{ width: `${upload.progress !== undefined ? upload.progress : (upload.processed_rows / upload.total_rows) * 100}%` }}
                            />
                          </div>
                          <div className="flex justify-between text-xs mt-1">
                            <span className="text-blue-700">Processing row {upload.processed_rows} of {upload.total_rows}</span>
                            <span className="text-gray-600">{upload.successful_rows} successful</span>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                        ...
                        {upload.status === 'completed' && upload.result_zip_path && (
                          <button
                            ...
                            className="px-5 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg flex items-center gap-2 text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200"
                          >
                            <Download className="w-4 h-4" />
                            Download ZIP
                          </button>
