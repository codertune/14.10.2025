            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                {remainingSubmissions !== null && (
                  <p className="text-sm text-gray-500 mt-2">
                    You can submit {remainingSubmissions} more message{remainingSubmissions !== 1 ? 's' : ''} in the next hour.
                  </p>
                )}
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+880 1947 214525</p>
